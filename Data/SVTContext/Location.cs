            ...
            modelBuilder.Entity<Location>(locationBuilder =>
            {
                ...
                locationBuilder
                    .HasData(
                        ...
                        new Location{ LocationId = 26, Name = "2501-MA-A-WAIT-001", LocationType = "wait", AreaId = 5 },
                        new Location{ LocationId = 27, Name = "2501-MA-A-WAIT-002", LocationType = "wait", AreaId = 5 },
                        new Location{ LocationId = 28, Name = "2501-MA-A-WAIT-003", LocationType = "wait", AreaId = 5 },
